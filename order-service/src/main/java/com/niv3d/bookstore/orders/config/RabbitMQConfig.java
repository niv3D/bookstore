package com.niv3d.bookstore.orders.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.niv3d.bookstore.orders.ApplicationProperties;
...
class RabbitMQConfig {
    ...
    DirectExchange exchange() {
        return ExchangeBuilder
                .directExchange(properties.orderEventsExchange())
                .build();
    }
    ...
    Queue newOrdersQueue() {
        return QueueBuilder
                .durable(properties.newOrdersQueue())
                .build();
    }
